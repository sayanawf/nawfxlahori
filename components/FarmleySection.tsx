...
const LIST_ITEMS = [
  "Claiming the after-food relief moment long before it became a category",
  "Becoming the unsaid default with street food, heavy meals, and late-night cravings",
  "Winning India by staying unpretentious, familiar, and mass-loved"
];
    ...
    >
       ...
       <div className="w-full mb-6 md:mb-10 relative z-10">
           <h2 className="farmley-header font-sans font-black text-2xl sm:text-3xl md:text-5xl lg:text-6xl leading-[1.1] uppercase max-w-6xl tracking-tighter text-white">
              <SplitText wordClass="split-word inline-block mr-3">
                LAHORI ZEERA’S “MOMENT-FIRST” ADVANTAGE RESULTED IN-
              </SplitText>
           </h2>
       </div>
       ...
       <div className="w-full mt-6 md:mt-10 pt-6 md:pt-8 border-t border-white/10 pb-6">
           <div className="farmley-footer font-sans font-black text-lg md:text-3xl lg:text-4xl leading-tight text-white uppercase max-w-6xl">
               <div className="mb-2">
                    <SplitText charClass="split-char inline-block">HABIT-FIRST BUILT THE BRAND. </SplitText>
                    <span className="text-red-600">
                        <SplitText charClass="split-char inline-block">AI-FIRST WILL PROTECT IT.</SplitText>
                    </span>
               </div>
               <div>
                    <SplitText charClass="split-char inline-block">FOOD DISCOVERY IS NOW ALGORITHM-LED </SplitText>
                    <br className="md:hidden" />
                    <span className="text-white border-b-2 border-red-600 inline-block">
                        <SplitText charClass="split-char inline-block">TASTE MEMORY IS NOW VISUAL + CONTEXTUAL</SplitText>
                    </span>
               </div>
           </div>
       </div>
